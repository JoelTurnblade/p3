...
@section('form')
    <form method='POST' action='/'>
        ...
        <input type='hidden' name='preOperation' value='{{ $operation or old('operation', null) }}'>
        <br>
        ...
        <input type='hidden' name='preFirstNumDig' value='{{ $firstNumDig or old('operation', null) }}'>
        <br>
        ...
        <input type='hidden' name='preSecondNumDig' value='{{ $secondNumDig or old('operation', null) }}'>
        <br>
        <p>{!! $displayString or old('displayString', '<br>') !!}</p>
        <input type='hidden' name='displayString' value='{{ $displayString or old('displayString', null) }}'>
        <input type='hidden' name='firstNum' value='{{ $firstNum or old('firstNum', null) }}'>
        <input type='hidden' name='secondNum' value='{{ $secondNum or old('secondNum', null) }}'>
        <input type='hidden' name='correctAnswer' value='{{ $correctAnswer or old('correctAnswer', null) }}'>
        <input type='text' name='userAnswer' value=@if($errors->any()) '{{ old('userAnswer', '') }}' @endif>
        <br>
